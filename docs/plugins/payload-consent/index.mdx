...
- A [legal audit](/docs/plugins/payload-consent/audit): a deterministic `payload-consent scan` that checks your documents against your own configuration, and an MCP server your own AI agent drives for the parts only a reader of prose can judge.
