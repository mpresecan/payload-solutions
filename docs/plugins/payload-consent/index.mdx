...
On first boot the plugin seeds four categories, the trackers you listed, and three legal pages — privacy policy, cookie policy with a live cookie table, and terms of service. From then on everything is edited in the admin under **Privacy**.
...
- Three seeded legal documents in Lexical, with tables, that editors can actually edit.
