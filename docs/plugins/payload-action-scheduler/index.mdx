...
- [Installation](/docs/plugins/payload-action-scheduler/installation) — install, declare, register, run. A new project can scaffold the whole thing with [Payload Stack](/docs/payload-stack/scheduling).
