...
/*
  Payload Clock's signature visual, and this site's counterpart to Payload Stack's IsoStack.
  ...
  delay per spoke, so:
    ...
    - `prefers-reduced-motion` kills every animation from one rule in globals.css and leaves
      a legible static diagram behind.
...
export function ClockDial({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 440 440"
      className={cn('clock-dial h-auto w-full', className)}
      role="img"
