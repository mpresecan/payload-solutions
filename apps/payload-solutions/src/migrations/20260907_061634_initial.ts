...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_status" AS ENUM('available', 'in-progress', 'planned');
  CREATE TYPE "public"."enum_plugins_status" AS ENUM('available', 'in-progress', 'planned');
  CREATE TYPE "public"."enum_roadmap_items_stage" AS ENUM('shipped', 'in-progress', 'planned', 'exploring');
  CREATE TYPE "public"."enum_contact_submissions_topic" AS ENUM('saas', 'stack', 'plugin', 'other');
  CREATE TYPE "public"."enum_contact_submissions_status" AS ENUM('new', 'replied', 'closed');
  ...
  CREATE TABLE "products" (
  	...
  	"status" "enum_products_status" DEFAULT 'planned' NOT NULL,
  	"url" varchar,
  	"docs_path" varchar,
  	"command" varchar,
  ...
  CREATE TABLE "plugins" (
  	...
  	"description" varchar,
  	"status" "enum_plugins_status" DEFAULT 'planned' NOT NULL,
  	"docs_path" varchar,
  	"repo_url" varchar,
  	"order" numeric DEFAULT 0,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "roadmap_items" (
  	...
  	"description" varchar NOT NULL,
  	"stage" "enum_roadmap_items_stage" DEFAULT 'planned' NOT NULL,
  	"quarter" varchar,
  	"link" varchar,
  	"order" numeric DEFAULT 0,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE UNIQUE INDEX "plugins_slug_idx" ON "plugins" USING btree ("slug");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_roadmap_items_stage";
