...
const LINES: Tok[][] = [
  ...
  [['', '  '], ['k', 'organizations'], ['', ': {']],
  [['', '    '], ['k', 'enabled'], ['', ': '], ['s', 'true'], ['', ',']],
  [['', '    '], ['k', 'allowUserToCreate'], ['', ': '], ['s', 'true'], ['', ',']],
  [['', '    '], ['k', 'creatorRole'], ['', ': '], ['s', "'owner'"], ['', ',']],
  [['', '  },']],
  [],
  [['', '  '], ['k', 'billing'], ['', ': {']],
  [['', '    '], ['k', 'provider'], ['', ': '], ['s', "'stripe'"], ['', ',']],
  ...
  [['', '    '], ['k', 'plans'], ['', ': [']],
  [['', '      { '], ['k', 'id'], ['', ': '], ['s', "'starter'"], ['', ', '], ['k', 'name'], ['', ': '], ['s', "'Starter'"], ['', ', '], ['k', 'priceId'], ['', ': env.'], ['k', 'STRIPE_PRICE_STARTER'], ['', ', '], ['k', 'seats'], ['', ': '], ['s', '3'], ['', ' },']],
  [['', '      { '], ['k', 'id'], ['', ': '], ['s', "'team'"], ['', ', '], ['k', 'name'], ['', ': '], ['s', "'Team'"], ['', ', '], ['k', 'priceId'], ['', ': env.'], ['k', 'STRIPE_PRICE_TEAM'], ['', ', '], ['k', 'seats'], ['', ': '], ['s', '25'], ['', ', '], ['k', 'trialDays'], ['', ': '], ['s', '14'], ['', ' },']],
  [['', '    ],']],
  [['', '  },']],
  [],
